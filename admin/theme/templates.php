...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Kuipers Group</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b><img src="/eris/dist/img/kuipers.png"></b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">Kuipers Group</a>.</strong> All rights
    reserved.
  </footer>
